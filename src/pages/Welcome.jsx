...
export default function WelcomePage() {
  /** by using useScroll, useTransform and style prop on the framer motion element you can apply scroll animations */
  const { scrollY } = useScroll();

  const yCity = useTransform(scrollY, [0, 400], [0, -200])
  const opacityCity = useTransform(
    scrollY,
    [0, 200, 300, 500],
    [1, 0.5, 0.5, 0]
  ); //* this change in the animation won't affect the component render cycle
  const yHero = useTransform(scrollY, [0, 400], [0, -500])
